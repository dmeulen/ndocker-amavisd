...
$mydomain = '{{ env "AMAVIS_MYDOMAIN" }}';   # a convenient default for other settings
...
$lock_file = "/run/amavis/lock";  # -L
$pid_file = "/run/amavis/pid";   # -P
...
#$unix_socketname = "/run/amavis/sock";  # amavisd-release or amavis-milter
               # option(s) -p overrides $inet_socket_port and $unix_socketname

$inet_socket_bind = '0.0.0.0';
$inet_socket_port = 10024;   # listen on this local TCP port(s)
@inet_acl = qw( {{ env "AMAVIS_ACL" }} );
...
$myhostname = '{{ env "AMAVIS_MYHOSTNAME" }}';  # must be a fully-qualified domain name!

$notify_method  = '{{ env "POSTFIX_RETURN" }}';
$forward_method = '{{ env "POSTFIX_RETURN" }}';  # set to undef with milter!
